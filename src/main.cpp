// comixzone - ReXGlue Recompiled Project
...
class ComixzoneApp : public rex::ui::WindowedApp, public rex::ui::WindowListener {
public:
    static std::unique_ptr<rex::ui::WindowedApp> Create(rex::ui::WindowedAppContext& ctx) {
        return std::make_unique<ComixzoneApp>(ctx);
    }

    ComixzoneApp(rex::ui::WindowedAppContext& ctx)
        : WindowedApp(ctx, "comixzone", "[game_directory]") {
    ...
    bool OnInitialize() override {
        ...
        REXLOG_INFO("comixzone starting");
        ...
        // Create window
        window_ = rex::ui::Window::Create(app_context(), "comixzone", 1280, 720);
        if (!window_) {
        ...
        // Register keyboard-to-gamepad input driver
...
XE_DEFINE_WINDOWED_APP(comixzone, ComixzoneApp::Create)
